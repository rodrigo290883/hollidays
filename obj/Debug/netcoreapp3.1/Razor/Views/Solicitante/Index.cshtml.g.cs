#pragma checksum "/Users/rodrigolira/Proyectos/hollidays/Views/Solicitante/Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "5fbe8cca03cbe1dcf815c1ae5ca9419e3bc2db01"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"5fbe8cca03cbe1dcf815c1ae5ca9419e3bc2db01", @"/Views/Solicitante/Index.cshtml")]
...
<div class=""container"">
    ...
    <div class=""row"">
        <div class=""col-4"">FECHA INICIO:<p id=""p_fecha_inicio""></p></div>
        <div class=""col-4"">FECHA FIN:<p id=""p_fecha_fin""></p></div>
    </div>
    <div class=""row"">
        <div class=""col-10"">
    ...
    $(function() {
        ...
        onDateSelect: function (date, events) {
            ...
            if (vacaciones.indexOf(fecha) == -1) {
                vac");
            WriteLiteral(@"aciones.push(fecha);
            }
            else {
            ...
            $(""#p_fecha_inicio"").html(fecha_inicio.toISOString());
